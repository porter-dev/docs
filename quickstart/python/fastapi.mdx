---
title: "Deploy a FastAPI app on Porter"
description: "Create, configure, and deploy a FastAPI application on Porter with requirements.txt, Dockerfile setup, and porter.yaml configuration"
---
