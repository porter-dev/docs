---
title: "Migrate from Porter Cloud to Standard"
description: "Export your application configuration from Porter Cloud and redeploy to Porter Standard in your own AWS, GCP, or Azure cloud account step by step"
---
