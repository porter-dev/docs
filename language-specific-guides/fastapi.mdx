...
Porter deploys your FastAPI application to a cloud provider of your choice in a few clicks, whether that is AWS, Google Cloud, or Azure. 
Just push your FastAPI code to a Git repository and let Porter handle the rest from CI/CD to autoscaling.
...
Porter will create the necessary infrastructure in your own AWS account.
