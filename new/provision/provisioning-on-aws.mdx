...
![Cloud Formation](/images/provisioning-infrastructure/cloud-formation-3-steps.png)
...
<Info>
  Common errors you may encounter during this process are AWS quota limits.
  Porter will prevent you from provisioning until these quota limits have been
  resolved. Troubleshooting steps will be shown on the dashboard if you
