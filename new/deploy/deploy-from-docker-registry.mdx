...
See [here](/new/deploy/types-of-services) for more information about the difference between service types.
...
See [here](/new/deploy/pre-deploy-jobs) for more details.
