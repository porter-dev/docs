...
<Info> For those who are not familiar with GitHub Actions, we recommend getting a basic overview from [their documentation](https://docs.github.com/en/actions). </Info>
...
To view your build logs on Porter, ... @feroze
...
Please note that `Secrets` will not be made available to your build process. Learn more about `Secrets` [here](/new/configure/environment-groups). 
