...
<Info>
AWS roles must be configured in the **Connections** tab of your cluster settings before they can be used in `porter.yaml`.
</Info>
...
You can attach multiple connections to a single service:
