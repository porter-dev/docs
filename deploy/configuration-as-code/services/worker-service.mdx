...
<Tip>
For best practices on combining command-based health checks with graceful shutdown (SIGTERM handling, shutdown markers), see [Zero-Downtime Deployments: Workers](/configure/zero-downtime-deployments#workers).
</Tip>
