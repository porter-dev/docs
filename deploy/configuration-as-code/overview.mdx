...
Share deployment configurations across your team. New team members can understand the entire application architecture from a single file.

### Multi-Environment Deployments

Use the same base configuration across development, staging, and production with environment-specific overrides.
