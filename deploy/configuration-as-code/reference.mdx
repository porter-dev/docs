...
- [name](#name) \- the name of the app. Must be 31 characters or less. Must consist of lower case alphanumeric characters or '-', and must start and end with an alphanumeric character.
...
- [services](#services) \- a list of services for this app.
  ...
  - **nodeGroup** - the ID of the user node group to run the service on. If not provided, the service will be run on the default node group.
