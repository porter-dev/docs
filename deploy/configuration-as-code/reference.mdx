...
When this attribute is enabled, Porter will automatically rollback to the latest previously successfully-deployed version of the app if the new version fails to deploy.
