...
It is not possible for services that belong to the same application to run a different application build or have a different set of environment variables. There are three different [types of services](/deploy/types-of-services) that you can deploy on Porter.
