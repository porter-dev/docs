...
A great way to get started with quickly pushing out your latest Nodejs app out is with Porter Cloud - you get the ability to run your app on our own hosted cloud infrastructure, without worrying about any of the details traditionally associated with your own cloud infrastructure. What's more - you get to build your app without ever having to actually define how your app is built. 
