...
2. Click on the **Enable APIs and Services** button at the top. This will bring up a catalog of APIs that you can enable on GCP. Enable the following APIs:
...
It might take a few minutes for each of these APIs to be enabled. Once you can confirm that all APIs are enabled from the **APIs & Services** tab, proceed to the next section.
...
3. After naming your service account, grant the service account the following permissions:
