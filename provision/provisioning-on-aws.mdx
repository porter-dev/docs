...
![Cloud Formation 3 steps](/images/provisioning-infrastructure/aws-credentials.webp)
...
3. After creating the CloudFormation stack, Porter will automatically create additional resources required to manage your account. Once this process complete, click **Continue**. You will be prompted to select the AWS region that you want to provision your infrastructure in.
