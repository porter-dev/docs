...
2. You will be directed to your AWS console to create a CloudFormation stack. If this window did not appear, please ensure that your browser has not blocked the pop-up window. This stack will create the role Porter will assume to manage your infrastructure.
   ...
   <Info>
     ...
     provisioned by the CloudFormation stack, please contact us through the support modal to inquire about Porter
     Enterprise. Porter Enterprise requires [minimum IAM
     permissions](enterprise/provisioning-on-aws#permissions-for-eks) that are
     smaller in scope.{" "}
   </Info>

3. After creating the role, navigate back to the Porter dashboard and click **Continue**. In the case that you do not have cloud credits, we have provided a breakdown of the monthly costs on AWS.
