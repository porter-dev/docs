---
title: "Autoscaling"
description: "Scale your web and worker services automatically using CPU and memory thresholds, custom Prometheus metrics, or Temporal task queue depth"
---
...
<Info>
For configuration-as-code (porter.yaml) autoscaling settings, see [Autoscaling Configuration](/applications/configuration-as-code/services/autoscaling).
</Info>
...
[Set up Custom Metrics Autoscaling →](/applications/observability/custom-metrics-and-autoscaling)
...
[Set up Temporal Autoscaling →](/applications/configure/temporal-autoscaling)
