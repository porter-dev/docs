...
description: "Complete field reference for porter.yaml including build, image, services, environment variables, predeploy, and autoscaling options"
---
...
Bind a GCP IAM service account to your service for GCP API access via GKE Workload Identity.
