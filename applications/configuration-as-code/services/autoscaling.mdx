---
title: 'Autoscaling in porter.yaml'
sidebarTitle: 'Autoscaling'
description: "Configure horizontal pod autoscaling in porter.yaml with CPU and memory utilization thresholds, min/max replicas, and scaling behavior"
---
