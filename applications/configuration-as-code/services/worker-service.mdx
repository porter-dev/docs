---
title: 'Worker services in porter.yaml'
description: "Complete field reference for worker services in porter.yaml including health checks, autoscaling, GPU allocation, and resource limits"
---
