---
title: 'Configuration as code with porter.yaml'
sidebarTitle: 'Overview'
description: "Define application services, builds, and deployment settings in a porter.yaml file for CI/CD pipelines and version-controlled infrastructure"
---
