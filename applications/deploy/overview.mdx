...
description: "Learn how applications and services work on Porter, connect GitHub repositories, and launch your first deployment from the dashboard"
---

Once you've provisioned infrastructure in your cloud account, you can start to deploy your first application. For a less in depth guide, check out [Quickstart](/getting-started/quickstart#step-4:-create-your-first-application). 
...
It is not possible for services that belong to the same application to run a different application build or have a different set of environment variables. There are three different [types of services](/applications/deploy/types-of-services) that you can deploy on Porter.
