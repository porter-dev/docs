...
2. **On the original app:** Remove the custom domain in the **Networking** tab.
3. **On the cloned app:** Add the custom domain and redeploy.

<Warning>
  Moving a domain between applications may cause disruption in service while the load balancer updates and DNS changes propagate.
  Ensure you have tested the cloned application thoroughly and understand the implications of the change.
</Warning>
