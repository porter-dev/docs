...
<Steps>
  ...
  <Step title="Configure the node group">
    ...
    <Info>
    **Health Checks Required**: For production applications on cost-optimized node groups, configure proper [health checks](/configure/zero-downtime-deployments#health-checks). This ensures applications can be safely rescheduled as nodes are reshuffled.
    </Info>
  </Step>
