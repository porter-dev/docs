...
<Steps>
  ...
  <Step title="Update">
    ...
    The **Machine type** dropdown includes a search input. Start typing an instance name (for example, `n2-standard-4` or `c6g`) to filter the list instead of scrolling through every option.
  </Step>
</Steps>
