...
<Note>
  This setting is deprecated in favor of the [Application load balancer](#application-load-balancer) setting described below. It remains supported for clusters already configured with it.
</Note>

### Application load balancer

This setting adds an additional public ALB next to the cluster default, rather than replacing it. Each service picks which load balancer serves it, so you can move domains over one at a time.
