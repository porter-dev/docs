...
<Note>
  If you are setting up an ALB now, use [Application load balancer](#application-load-balancer) below instead. This setting is kept for clusters already running on it.
</Note>
