...
<Tabs>
  ...
  <Tab title="GCP">
    ...
    <AccordionGroup>
      <Accordion title="Enable the Cloud Resource Manager API" icon="toggle-on">
        ...
        The API may take a few minutes to enable. Porter will automatically enable all other required APIs (Compute Engine, Kubernetes Engine, Artifact Registry, Secret Manager, etc.) after you upload your credentials.
      </Accordion>
    </AccordionGroup>
