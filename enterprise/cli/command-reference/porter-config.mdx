---
title: "porter config"
description: "View and update Porter Enterprise CLI local configuration including project, cluster, host, and registry settings with the config command"
---
...
| Flag | Description |
|------|-------------|
| `--show-token` | Display the CLI authentication token and session fields in the output. By default, these are hidden for security. |
