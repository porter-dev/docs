...
description: "Connect external Kubernetes clusters via kubeconfig, Docker registries, and Helm repositories to your Porter Enterprise instance via the CLI"
---
...
Note that there is a detailed guide for setting up registry connections [here](/applications/deploy/deploy-from-docker-registry).
