...
description: "View application logs from the Porter Enterprise CLI. This command is deprecated — use porter app logs to stream and filter logs in current versions."
---
