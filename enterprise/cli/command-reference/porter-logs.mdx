...
description: "View application logs from the deprecated Porter Enterprise CLI command. Use porter app logs for current log streaming and tailing with --follow."
---
