...
<Info>You can also connect an existing registry after the project has been created if you decide to deploy from another image registry. [You can read the step by step instructions on how to connect each of the image registry providers here.](/enterprise/deploying-applications/deploying-from-docker-registry/linking-existing-registry). </Info>
