...
## `preview.yaml` File Walkthrough[](#porteryaml-file-walkthrough "Direct link to heading")

The `preview.yaml` file to define both a Postgres database and a web application is as follows:
