...
<Tabs>
  ...
  <Tab title="Deploy from a Docker registry">
   ...
   <Tab title="Deploy using the CLI">
    ...
    <Steps>
      ...
      <Step title="Create a porter.yaml file">
        ...
        Adjust the `run` command and `port` to match your application. See the [porter.yaml reference](/deploy/configuration-as-code/reference) for all available options.
      </Step>
