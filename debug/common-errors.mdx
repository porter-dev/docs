...
* You have connected an image registry to Porter. For more information, see the [deploy overview guide](/deploy/overview) or the doc on [deploying from a Docker registry](/deploy/deploy-from-docker-registry)
