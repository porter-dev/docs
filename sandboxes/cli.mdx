...
The destination's parent directory must already exist, and nothing is replaced — the server refuses a move onto an occupied path. The volume root cannot be moved or overwritten.
