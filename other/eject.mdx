...
Once the `porter.yaml` file is ready and is present in the root folder of your repository, head back to the [dashboard](https://dashboard.getporter.dev) and deploy a new application from your github repository. 
