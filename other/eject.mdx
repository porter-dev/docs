...
description: "Migrate your applications from Porter Cloud to your own AWS, Azure, or GCP account by exporting porter.yaml and switching DNS records"
---
...
The first step to ejecting your applications is to grant Porter permissions to your cloud account so it can create the necessary underlying infrastructure. Select the **Bring your own Cloud** option from our [website](https://porter.run) and [follow this guide](/cloud-accounts/overview) to provision
...
For a step by step guide on how to do this, [please follow this guide](/applications/deploy/deploy-from-github-repo).
...
You can find the Load Balancer's IP address to point at in the **Networking** tab of your application. Refer to [this guide](/applications/configure/custom-domains) for more details. This switchover may incur downtime. In most cases, it should not incur more than
