...
account to create the necessary underlying infrastructure for you to start deploying applications. [Please follow this guide](/provision/provisioning-on-aws) to provision
