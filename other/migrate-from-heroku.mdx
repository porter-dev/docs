...
Once your infrastructure has been provisioned, you will be able to [launch applications](/deploy/overview#launch-your-application) from the dashboard.
...
It is possible to configure more than just start commands on `porter.yaml`. For a full guide on how to write a `porter.yaml` file, [take a look here](/deploy/configuration-as-code/overview).
...
For a step by step guide on how to do this, [please follow this guide](/deploy/overview).
...
Porter uses [GitHub Actions to build your applications](/deploy/builds). To debug your application builds, take a look at your build logs from the **Actions** tab
...
The final step is to switch over your production traffic by changing your DNS records. [Follow this guide](/configure/custom-domains) to add your custom domain to the 
