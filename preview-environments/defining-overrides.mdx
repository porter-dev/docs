...
You will also have to create a wildcard record in your DNS provider for the base domain (e.g. `*.my-domain.com`) that points to the ingress IP for your cluster. This can be found in the **Networking** tab of any of your web services.
