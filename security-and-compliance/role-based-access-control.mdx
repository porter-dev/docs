...
To set up just in time user provisioning, you must be logged in with an **Admin** role. As an admin, you can find the setup in **Settings** then **Members** in the sidebar then go to the **SSO** tab. 

You will first need to request SSO setup for your organization. A porter team member will create an SSO organization for you and email you a link to set this up with your identity provider.

After configuring your identity provider, go back to the **SSO** tab and click **Set Up** to login with an account. Ensure that you log in with an account connected to your organization, not your personal email.
