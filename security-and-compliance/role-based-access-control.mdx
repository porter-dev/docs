...
1. To set up SSO, you will first need to request **SSO provisioning** for your organization. A porter team member will create an SSO organization for you and email you a link to set this up with your identity provider.
