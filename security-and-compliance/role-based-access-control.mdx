...
To set up just in time user provisioning, you must be logged in with an **Admin** role. As an admin, navigate to **Settings** then **Members** in the sidebar. Navigate to the **SSO** tab and click **Set Up**. You will then be prompted to login with an account. Ensure that the account you log in is connected to your organization and is not your personal email.
