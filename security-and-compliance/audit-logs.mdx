---
title: "Audit logs"
description: "Review project activity across the Porter dashboard, CLI, and API tokens, filter audit log entries by user or action, and export results for security reviews"
---
