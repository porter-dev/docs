...
description: "Review the IAM roles, policies, and CloudFormation stack permissions that Porter creates and requires to manage your AWS cloud infrastructure"
---
