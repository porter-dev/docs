...
3. After naming your service account, grant the service account these four permissions:
...
![Select GCP](https://github.com/porter-dev/porter/assets/10238219/84cc53f0-b7cc-4449-8a4d-9f7b1f297438 "Cloud providers")
...
![Upload GCP Service Account](https://github.com/porter-dev/porter/assets/10238219/7ba5b057-af9d-4568-99c3-6fc221739d43 "Upload GCP Service Account JSON")

3. Select the region that you would like to provision in, then click "Provision"

![Provision](https://github.com/porter-dev/porter/assets/10238219/1fd95b17-081e-4a78-af86-ec1e91df9987 "Configure cluster settings to provision")
