...
Run the following command to generate the role definition and save it as a local variable.

```
$ PORTER_ROLE_DEFINITION=$(envsubst << EOF
{
...
Finally, create your role using the role definition you just saved:

```
$ az role definition create --role-definition ${PORTER_ROLE_DEFINITION}
```
