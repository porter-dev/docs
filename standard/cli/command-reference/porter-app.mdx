...
```bash Time Range
porter app logs my-app --from 2024-01-01T10:00:00Z --to 2024-01-01T12:00:00Z
```
...
Delete an application from Porter.

**Usage:**
```bash
porter app delete [APP_NAME] [flags]
```
...
<Warning>
This action is destructive and cannot be undone. All services and data associated with the app will be deleted.
</Warning>
