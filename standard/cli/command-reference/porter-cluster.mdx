...
description: "List clusters and view cluster details including node groups, Kubernetes version, cloud provider configuration, and status using the Porter CLI"
---
