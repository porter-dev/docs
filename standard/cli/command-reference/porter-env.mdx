---
title: 'porter env'
description: "Create, list, get, set, and unset environment group variables and secrets from the Porter CLI for project-wide configuration management"
---
...
The default table output shows each group's name, current version, and last updated time.
