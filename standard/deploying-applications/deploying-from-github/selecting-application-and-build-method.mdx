...
To deploy your application, first navigate to the "Launch" tab, where you will see three types of applications to deploy: web, worker, or job. To understand the difference between these three application types, see the description of the [types of applications](/standard/deploying-applications/overview#types-of-applications). Then follow the four steps below to get your application linked up.
...
* [Web Applications](/standard/deploying-applications/runtime-configuration-options/web-applications)
* [Worker Applications](/standard/deploying-applications/runtime-configuration-options/worker-applications)
* [Jobs and Cron Jobs](/standard/running-jobs/overview)
