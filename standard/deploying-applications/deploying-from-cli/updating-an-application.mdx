...
Go to the [common configuration options](/standard/deploying-applications/deploying-from-cli/common-configuration-options) section to view `values.yaml` files for common use-cases.
