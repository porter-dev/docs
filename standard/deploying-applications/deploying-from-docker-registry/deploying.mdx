...
<Tabs>
  <Tab title="Private">
    To deploy from a private image, make sure you have [linked a private registry](/standard/deploying-applications/deploying-from-docker-registry/linking-existing-registry). Then, simply select the image repo and tag you would like to use:
